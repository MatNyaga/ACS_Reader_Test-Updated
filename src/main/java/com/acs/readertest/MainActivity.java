...
public class MainActivity extends Activity {
    ...
    byte[] displaytext = new byte[] { (byte) 0xFF, (byte) 0xCA, (byte) 0x00, (byte) 0x00, (byte) 0x00 };
        ...
        mReader.setOnStateChangeListener(new OnStateChangeListener() {
            ...
            public void onStateChange(int slotNum, int prevState, int currState) {
                ...
                try {
                    ...
                    mystring = UIDBuffer(baResp,baResp.length);
                    Intent myIntent = new Intent(MainActivity.this, uidactivity.class);
                    myIntent.putExtra("UID", mystring); //Optional parameters
                    ...
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (slotNum != Spinner.INVALID_POSITION) {
                                ...
                                // Set parameters
                                TransmitParams params = new TransmitParams();
                                params.slotNum = slotNum;//Reader.IOCTL_ACR83_DISPLAY_LCD_MESSAGE;
                                params.controlCode = 3500;
                                String hello = "Hello World";
                                byte message = Byte.valueOf(hello);
                                /*

                                String msg = "";
                                try {
                                    //params.
                                    msg = toHexString(mLcdMessage
                                            .getBytes("US-ASCII"));
                                    message =  Byte.valueOf(msg);
                                } catch (UnsupportedEncodingException e) {
                                    message = (byte)0xFF;;
                                }
                                    */
                                byte[] displaytext = new byte[] { (byte) 0xFF, (byte) 0x00, (byte) 0x68, (byte) 0x00, (byte) hello.length(), message };
                                params.command = displaytext;
                                // Transmit control command
                                /*logMsg("Slot "
                                        + slotNum
